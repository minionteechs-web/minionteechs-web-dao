...
contract GovernanceToken is ERC20, ERC20Votes, Ownable {
    ...
    constructor() ERC20("MinionTechs DAO Token", "MTD") ERC20Permit("MinionTechs DAO Token") {}

    /**
     * @dev Mint tokens (only owner/DAO)
     */
     ...
     * @dev Burn tokens
     */
    function burn(uint256 amount) public override(ERC20Votes) {
